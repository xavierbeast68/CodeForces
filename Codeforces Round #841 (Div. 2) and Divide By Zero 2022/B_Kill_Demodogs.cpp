/**
 * CODER=> xavierbeast68
 * Problem : Kill Demodogs ->Codeforces Round #841 (Div. 2) and Divide By Zero 2022
 * Date : 27-12-2022
...
void solve()
{
    ...
    */
    // int sum1 = ((((n * (n + 1)) % MOD) * (2 * n + 1)) % MOD) / 6;
    // int sum2 = (((((n - 1) * (n)) % MOD) * (n + 1)) % MOD) / 3;
